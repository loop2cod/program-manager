...
const menuItems = [
  ...
  },
  {
    ...
    url: "/dashboard/program-winners",
    icon: Award,
  },
  {
    title: "All Program Winners",
    url: "/dashboard/all-program-winners",
    icon: Medal,
  },
  {
    title: "Students Without Prizes",
    url: "/dashboard/students-without-prizes",
    icon: UserX,
  },
]
